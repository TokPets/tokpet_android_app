...
public class Constants {
    public Constants(){}
    // Root page
    public static String WEBAPP_URL = "https://tokpetsapp.firebaseapp.com/";
    public static String WEBAPP_HOST = "tokpetsapp.firebaseapp.com/"; // used for checking Intent-URLs
